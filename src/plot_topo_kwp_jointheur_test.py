...
def main():
    ...
    data_all_algorithm = os.path.join(dir_data, "results_kwp_all_algorithms.json")
    if os.path.exists(data_all_algorithm):
        ...
        print(f"{utility.FAIL}results_kwp_all_algorithms.json not existing in {dir_data}{utility.CEND}")

    # figure (all_topologies)
    data_all_topologies = os.path.join(dir_data, "results_kwp_all_topologies.json")
    ...
    # figure (real_demands)
    data_real_demands = os.path.join(dir_data, "results_kwp_real_demands.json")
